...
Настройки собраны в три карточки: среда, травоядные и хищники. Текущее значение видно рядом с названием параметра, а минимальное и максимальное — под ползунком. Изменения сохраняются автоматически; кнопка «Сбросить» возвращает значения по умолчанию. После клика по ползунку его значение можно менять стрелками клавиатуры.

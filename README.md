...
Настройки разделены на общие, настройки травоядных и настройки хищников. У каждого ползунка подписаны минимальное и максимальное значения. После клика по ползунку его значение можно менять стрелками клавиатуры.
